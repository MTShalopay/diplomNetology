...
extension String {
    func getHeight() -> CGFloat {
        ...
        let boundingBox = self.boundingRect(with: constraintRect, options: .usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font: UIFont(name: "rubik-regular", size: 18)!], context: nil)
